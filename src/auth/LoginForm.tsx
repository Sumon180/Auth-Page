    ...
    <>
      <div className="flex items-center justify-center h-screen w-screen  bg-[#f8f7fa]">
        <div className="bg-white rounded p-5">
          <form action="">
            <div className="">
              <h1 className=" text-3xl text-slate-600 mb-2">Login</h1>
              ...
              <div className="flex flex-col gap-4">
                <div className="relative">
                  ...
                  />
                  <label className="absolute top-[50%] translate-y-[-60%] text-gray-500 left-[15px]">
                    Enter Email
                  </label>
                </div>
              ...
              <button
                type="submit"
                className="flex items-center justify-center bg-[#655BD3] text-white hover:bg-[#5147bb] transition-all duration-200 w-full h-10 rounded-md mb-8 text-2xl"
              >
                Login
              </button>
            </div>
