...
const SideNav = () => {
  ...
  return (
    <>
      <div
        className={` h-screen border-r-[1px] border-blue-100 ${
          state
            ? "w-3/12 transition-all duration-300"
      ...
      >
        <div className="relative">
          <div
            ...
            className="absolute rounded-full flex items-center justify-center w-8 h-8 top-10 right-[-16px] bg-white border border-blue-600"
          >
            <ChevronLeftIcon
              className={`w-4 h-4 ${state ? "hidden" : "block"}`}
            />
            <ChevronRightIcon
              className={`w-4 h-4 ${state ? "block" : "hidden"}`}
            />
          </div>
        </div>
        <div className="mx-4">
          <div className="">
            ...
            <div className="flex flex-col justify-start">
              <button
                className={`flex items-center justify-center rounded text-white bg-blue-600 ${
                  state ? "w-10 h-8 text-3xl" : "w-full h-8"
                }`}
              >
                {state ? "+" : "Create new"}
              </button>
              ...
              <ul className="flex flex-col gap-5">
                <li
                  className={`cursor-pointer text-blue-600 rounded hover:bg-blue-gray-100 transition-all duration-300 ${
                    state
                      ? "flex items-center justify-center w-10 h-8"
                      : "flex items-center gap-3 w-full h-8 pl-2"
                  }`}
                >
                  <svg
                ...
                <li
                  className={`border-l-4 border-blue-700 bg-blue-50 cursor-pointer text-blue-600 rounded hover:bg-blue-gray-100 transition-all duration-300 ${
                    state
                      ? "flex items-center justify-center w-10 h-8"
                      : "flex items-center gap-3 w-full h-8 pl-2"
                  }`}
                >
                  ...
                  <span className={`${state ? "hidden" : "block"}`}>Links</span>
                </li>
                <li
                  className={`cursor-pointer text-blue-600 rounded hover:bg-blue-gray-100 transition-all duration-300 ${
                    state
